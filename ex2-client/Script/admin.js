...
const instructorsAPI = `https://proj.ruppin.ac.il/cgroup85/test2/tar1/api/Instructors`;
var instructorsData = [];
...
function insertCourses(CourseData) {
    api = "https://proj.ruppin.ac.il/cgroup85/test2/tar1/api/Courses";
        ...
        coursesFromServer[0].forEach(function (course) {
            ...
            if (course.title == courseTitle) {
                ...
                editForm.on("submit", function (event) {
                    ...
                    let id = courseId;
                    const api = `https://proj.ruppin.ac.il/cgroup85/test2/tar1/api/Courses/${id}`;
...
function updateCourseData() {
    ...
    coursesFromServer.length = 0;
    let api = `https://proj.ruppin.ac.il/cgroup85/test2/tar1/api/Courses/`;
    $.ajax({
        url: api,
        type: 'GET',
        async: false,
